package com.khushalsapplication.app.modules.amethyst.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class AmethystModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtAmethyst: String? = MyApp.getInstance().resources.getString(R.string.lbl_amethyst)
  ,
  /**
   * TODO Replace with dynamic value
   */
