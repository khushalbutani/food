package com.khushalsapplication.app.modules.summitrestaurant.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class SummitRestaurantModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtSummitRestaura: String? =
      MyApp.getInstance().resources.getString(R.string.msg_summit_restaura)
  ,
  /**
   * TODO Replace with dynamic value
   */
