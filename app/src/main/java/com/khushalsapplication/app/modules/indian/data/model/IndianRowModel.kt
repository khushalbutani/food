...
data class IndianRowModel(
  /**
   * TODO Replace with dynamic value
   */
  var txtFriedRice: String? = MyApp.getInstance().resources.getString(R.string.lbl_fried_rice)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_indian_s_classi)
  ,
  /**
   * TODO Replace with dynamic value
   */
