package com.khushalsapplication.app.modules.aish.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class AishModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtAish: String? = MyApp.getInstance().resources.getString(R.string.lbl_aish)
  ,
  /**
   * TODO Replace with dynamic value
   */
