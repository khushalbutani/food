...
data class SpainModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtCountry: String? = MyApp.getInstance().resources.getString(R.string.lbl_spain)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtCountryOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_spain_today)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtAjoBlancoVerm: String? =
      MyApp.getInstance().resources.getString(R.string.msg_ajo_blanco_verm)
  ,
  /**
   * TODO Replace with dynamic value
   */
