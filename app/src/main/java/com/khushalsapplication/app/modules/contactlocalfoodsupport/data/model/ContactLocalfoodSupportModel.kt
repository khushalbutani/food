package com.khushalsapplication.app.modules.contactlocalfoodsupport.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class ContactLocalfoodSupportModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroup296: String? = MyApp.getInstance().resources.getString(R.string.lbl_enter_feedback)
  ,
  /**
   * TODO Replace with dynamic value
   */
