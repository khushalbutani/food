package com.khushalsapplication.app.modules.thefattybao.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class TheFattyBaoModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTheFattyBao: String? = MyApp.getInstance().resources.getString(R.string.lbl_the_fatty_bao)
  ,
  /**
   * TODO Replace with dynamic value
   */
