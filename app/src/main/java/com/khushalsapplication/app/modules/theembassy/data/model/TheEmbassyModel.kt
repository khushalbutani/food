package com.khushalsapplication.app.modules.theembassy.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class TheEmbassyModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTheEmbassy: String? = MyApp.getInstance().resources.getString(R.string.lbl_the_embassy)
  ,
  /**
   * TODO Replace with dynamic value
   */
