package com.khushalsapplication.app.modules.thebombaycanteen.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class TheBombayCanteenModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTheBombayCant: String? =
      MyApp.getInstance().resources.getString(R.string.msg_the_bombay_cant)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtCanteen: String? = MyApp.getInstance().resources.getString(R.string.lbl_canteen)
  ,
  /**
   * TODO Replace with dynamic value
   */
