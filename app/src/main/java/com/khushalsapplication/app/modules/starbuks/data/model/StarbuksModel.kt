package com.khushalsapplication.app.modules.starbuks.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class StarbuksModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtCafe: String? = MyApp.getInstance().resources.getString(R.string.lbl_cafe2)
  ,
  /**
   * TODO Replace with dynamic value
   */
