package com.khushalsapplication.app.modules.ballygungeplace.`data`.model

import com.khushalsapplication.app.R
import com.khushalsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class BallygungePlaceModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_ballygunge_plac)
  ,
  /**
   * TODO Replace with dynamic value
   */
